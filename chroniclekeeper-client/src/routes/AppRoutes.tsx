...
import UniversityMajorDetail from "../components/entityViews/universityMajor/detail/UniversityMajorDetail";
    ...
    return (
        <Routes>
            ...
            >
                ...
                <Route path="university-majors/:id" element={<UniversityMajorDetail />} />
