...
export default function HistoryList() {
    ...
    const newButton = canCreate ? (
        <Button onClick={() => navigate("/storymap/histories/new")}>
            + {t("form.newTitle")}
        </Button>
    ) : undefined;
    ...
    const columns: Column<HistoryDto>[] = [
        ...
        },
        {
            ...
            sortable: true,
            value: (r) => (r.isOfficial ? "1" : "0"),
            render: (r) => (
                <Tag tone={r.isOfficial ? "accent" : "neutral"}>
                    {r.isOfficial ? t("official") : t("unofficial")}
                </Tag>
            ),
        },
        {
    ...
    return (
        <div className={s.page}>
            <DataTable<HistoryDto>
                data={histories}
                columns={columns}
                getRowId={(r) => String(r.id)}
                onRowClick={(row) => navigate(`/storymap/histories/${row.id}`)}
                title={t("listTitle")}
