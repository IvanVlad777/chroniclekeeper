        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Locations_Parent_NotSelf", "[ParentLocationId] <> [Id]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timelines_Worlds_WorldId",
                        column: x => x.WorldId,
                        principalTable: "Worlds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppearanceTraits = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    GeneticFeatures = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Adaptations = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    WorldId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Consequences = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimelineEvents_Worlds_WorldId",
                        column: x => x.WorldId,
                        principalTable: "Worlds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialPhysicalFeatures = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SapientSpeciesId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Characters_Father_NotSelf", "[FatherId] <> [Id]");
                    table.CheckConstraint("CK_Characters_Mother_NotSelf", "[MotherId] <> [Id]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CharacterRelationships_NotSelf", "[CharacterId] <> [RelatedCharacterId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factions_Locations_HeadquartersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FactionMembers_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FactionTags", x => new { x.FactionId, x.TagId });
                    table.ForeignKey(
                        name: "FK_FactionTags_Factions_FactionId",
                        column: x => x.FactionId,
                        principalTable: "Factions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FactionTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterRelationships_CharacterId_RelatedCharacterId_Type",
                table: "CharacterRelationships",
                columns: new[] { "CharacterId", "RelatedCharacterId", "Type" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactionMembers_FactionId_CharacterId",
                table: "FactionMembers",
                columns: new[] { "FactionId", "CharacterId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Factions_HeadquartersId",
                table: "Factions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Factions_WorldId_Name",
                table: "Factions",
                columns: new[] { "WorldId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_FactionTags_TagId",
                table: "FactionTags",
                column: "TagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_WorldId_Name",
                table: "Tags",
                columns: new[] { "WorldId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimelineEvents_TimelineId_SortOrder",
                table: "TimelineEvents",
                columns: new[] { "TimelineId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_TimelineEvents_WorldId_Name",
                table: "TimelineEvents",
                columns: new[] { "WorldId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Timelines_WorldId_Name",
                table: "Timelines",
                columns: new[] { "WorldId", "Name" });
