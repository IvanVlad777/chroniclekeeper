...
{
    public class ApplicationDbContextOLD : IdentityDbContext<IdentityUser, IdentityRole, string>
    {
        public ApplicationDbContextOLD(DbContextOptions<ApplicationDbContext> options) : base(options) { }
    ...
    public class ApplicationDbContextFactoryOLD : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
